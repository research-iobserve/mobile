...
public final class Opt<T> {
    ...
    public interface IFkt<T, R> extends Function<T, R> {
        ...
        /**
         * Just the same as {@link #apply(Object)}. Butter readability when used with
         * {@link Opt#ifPresent()}. <br>
         * <br>
         *
         * <b>Terminal action:</b> If this or {@link #apply(Object)} is not called, nothing will
         * happen.
         *
         * @param t
         *            input
